...
int main(){
	if(!file("is_file_good")){
		cout << "正在补全文件..." << endl;
		system(".\\silent_downloader -url https://github.com/zcygod1337/download/releases/download/Nothing_here/test.7z");
		system(".\\7z.exe x test.7z");
		cout << "文件补全完毕！" << endl;
		system("echo > is_file_good"); 
	}
	ero();
